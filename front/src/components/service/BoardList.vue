<template>
<h2 style="text-align:center">게시물</h2><br><br><br>
<!-- 신고버튼 -->
<button style="float: right;margin: 10px;" type="button" class="btn btn-warning">신고하기</button>
<!-- 타이틀 -->
...
<div id="textarea" class="input-group">
  <div style="text-align: center" class="form-control" aria-label="With textarea" >{{list.body}}</div>
</div>

<!-- 수정및목록이동 버튼 -->
<div class="col-md-12 text-center">
  <!-- Button trigger modal -->
<button type="button" class="btn btn-primary" data-bs-target="#exampleModal" @click="MADAL_REGISTER">
모달
</button>{{modalToggle}}
...
<div id="comment" class="col-md-8 text-right">
  ...
  <ul style="list-style:none;">
    <li>
      <h2 style="background-color: rgba(176, 201, 183, 0.219); text-align:center;">댓글</h2>
    </li>
    <li>
      <div id="title">
        <span>닉네임: </span>
        <span>내용</span>
        <button id="commentdel" type="button" class="btn btn-light">삭제</button>
      </div>
    </li>
    <li>
      <div id="title">
        <span>마징가: </span>
        <span>내용없음</span>
        <button id="commentdel" type="button" data-bs-toggle="modal" class="btn btn-light">삭제</button>
      </div>
    </li>
    <li>
      <div id="title">
