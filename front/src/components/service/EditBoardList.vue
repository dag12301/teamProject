...
<div class="container" style="width: 1000px;">
  ...
  <br />
  <div >
      <button type="button" class="btn btn-primary" style="margin-right:20px;" @click="updateBoard">수정</button>
      <button
        id="btn"
        type="button"
    ...
    <thead id="title" style="text-align: center">
      <tr style="border-bottom: 1px solid gainsboro;">
        <th class="boardTitle" colspan='3' style="text-align: left; padding: 20px;">
          <span>구분</span><input type="text" style="padding-left:50px; font-size: 25px;" v-model.trim="title">
        </th>
      </tr>
      <tr style="height:40px;">
        <th class="col-md-5" style="text-align: left; padding-left: 20px;">{{nickname}}</th>
        <th class="col-md-2"><i class="far fa-clock"></i>&nbsp;&nbsp;{{regDate}}</th>
        <th class="col-md-1"><i class="far fa-eye"></i>&nbsp;&nbsp;{{hit}}</th>
      </tr>
    </thead>
  </table>
